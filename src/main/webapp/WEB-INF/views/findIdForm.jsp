...
<h2 class="text-center" style="font-family: 'Do Hyeon', sans-serif; font-size: 35px;">성명과 휴대폰 번호를 입력하세요</h2>
<div class="login-form">
    <form action="/javas/findID" method="post">   
        <div class="form-group">
        	<div class="input-group">
                <span class="input-group-addon"><i class="fa fa-user"></i></span>
                <input type="text" class="form-control" name="name" placeholder="성명을 입력해주세요" required="required">				
            </div>
        </div>
		<div class="form-group">
            <div class="input-group">
                <span class="input-group-addon"><i class="fa fa-lock"></i></span>
                <input type="tel" style="font-size:15px;" class="form-control" name="phone" placeholder="000-0000-0000 형식으로 입력하세요." required="required">				
            </div>
        </div>        
        <div class="form-group">
